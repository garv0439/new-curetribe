...
const footerLink = 'text-brand/90 transition hover:text-brand'

export default function Footer() {
  return (
    <footer id="contact" className="border-t border-brand-muted bg-white">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <img
              ...
              height={48}
            />
            <p className="max-w-md font-serif text-sm leading-relaxed text-brand/80">
              MOVE BETTER FEEL BETTER — Expert physiotherapy, nutrition, and mental wellness support for a balanced
              body and mind.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-brand/85">
        ...
        <div className="mt-12 border-t border-brand-muted/80 bg-brand-muted/20 py-6 text-center text-xs text-brand/70">
